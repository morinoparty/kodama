/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3cc5561f8a49396f319a8ed0dfa2309c)
// Runtime types generated with workerd@1.20260811.1 2025-09-02 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	AUTH_SECRET: SecretsStoreSecret;
	CLIENT_ID: "REPLACE_WITH_KODAMA_MINEAUTH_CLIENT_ID";
	MAIN_SERVER_URL: "https://api.morino.party/main";
	SERVER_URL: "https://api.morino.party/";
	SERVERS: "main,res,lobby";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLIENT_ID" | "MAIN_SERVER_URL" | "SERVER_URL" | "SERVERS">> {}
}
